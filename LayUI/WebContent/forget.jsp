	...
	<section data-reactroot="" class="route-wrapper">
		...
		<div class="step1 illegal-records-add register-view">
			...
			<div
				...
				<h2 class="f20 mb20 b" style="padding-left:45%">忘记密码</h2>
<!-- 				<div
				...
				<div class="mb20_ mb__ form-view" style="padding-left:30%">
						...
						<div class="ant-row">
							<div class="ant-col ant-col-7 ant-col-offset-4">
								<button type="button" class="ant-btn ant-btn-primary ant-btn-lg"
									...
									<a id="nextRegister" onclick="LoginOne()"><span>提交</span></a>
								</button>
							</div>
						</div>
					</footer>
...
function SendSmsCpatcha() {
    ...
    $.ajax({
        type: 'POST',
        url: 'dj/SendSmsCaptcha?tick=' + new Date().getTime(),
        cache: false,
...
function LoginOne() {
    ...
    $.ajax({
        type: 'POST',
        url: 'dj/Forgetmm?tick=' + new Date().getTime(),
        cache: false,
        data: {'phoneNumber': phone,'mm': mm,'phoneyzm': $.trim($('[name=yzm]').val()) },
        dataType: 'JSON',
        success: function (data) {           
            if (data.success) { 
            	alert("修改成功");            	
