										 ...
										 switch (result[i].formtypes){
										   ...
										   case "date":
										    ...
										    case "pic":
												...
												frOmInput += "<div class='file-iteme' style='width: 92px;height: 92px;display:inline-block;margin-right: 10px;'>"+img+"</div>"
