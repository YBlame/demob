		...
		        //请求成功时处理
										...
										//获取表头并且获取数据
											...
											    success:function(data){
								                    ...
								                    table.render({
								                    	elem : '#demo',
														height : 420,		//描述
														url : 'gzry/findHcxxTable?guid='+guid+"&num="+num//数据接口
														,
														title : '记录表',
														page:true,
				...
				function chakan(zhxxguid,dataGuid,dwbh) {
				    layer.open({
				        ...
				        title: '审核',
				        maxmin: true,
				        content: 'zhxx/hcxxsh.jsp?zhxxguid=' + zhxxguid+'&dataGuid='+dataGuid+'&dwbh='+dwbh, //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
				    });
