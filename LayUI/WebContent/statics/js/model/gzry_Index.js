...
$(document).ready(function () {
    ...
    var typeDj = true;
    $.ajax({
        url: "gzry/queryCondition",//请求的url地址
...
layui.use(['laydate', 'laypage', 'layer', 'table',
            ...
            'slider'], function () {
                       ...
                       /* async: false,*///请求是否异步，默认为异步，这也是ajax重要特性
                        ...
                        success: function (data) {
                            ...
                            for (var k = 0; k < doclist.length; k++) {
                                ...
                                var formtypes = doclist[k].formtypes;
                                var t;
                                //不显示还有'_ZT'的列
                                if (zdm.indexOf('_ZT') == -1&&zdm!="ZWJGT"&&zdm!="SJY"&&zdm!="BGDH"&&zdm!="CTSJS"&&zdm!="GCSSJH"&&zdm!="GCSZZZS") {
                                    //添加固定列以及设置宽度
                                    if (zdm == "ZGH" || zdm == "ZWH") {
                                        t = {
                                            field: zdm,
                            ...
                            table.render({
                                elem: '#demo',
                                height: 420,		//描述
                                url: 'gzry/findDocTable?guid=' + guid + "&num=" + num//数据接口
                                ,
                                title: '记录表',
                                page: true, //开启分页
                                    ...
                                    switch (obj.event) {
                                        case 'add':
                                            ...
                                            if (guidBmodel == null || guidBmodel == "null" || guidBmodel == undefined || guidBmodel == "") {
                                                var guid = $("#guid").val();
                                                window.location.href = "gzry/toAddDataJsp?guid=" + guid;
                                            } else {
                                                window.location.href = "gzry/toAddDataJsp?guid=" + guidBmodel;
                                            }
                ...
                table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                    ...
                    if (layEvent === 'detail') {
                        ...
                        if (guidBmodel == null || guidBmodel == "null" || guidBmodel == undefined || guidBmodel == "") {
                            ...
                            window.location.href = "gzry/toUpdateDoc?guid=" + guid + "&guidBmodel=" + guidB;
                        } else {
                            window.location.href = "gzry/toUpdateDoc?guid=" + guid + "&guidBmodel=" + guidBmodel;
                        }
                        //方便显示表单
                ...
                // 打开查看按钮 href="zhxx/bgxxsh.jsp"
                /*      var chakan=function() {
                          window.location = "bgxxsh.jsp?guid="
                                  + guid;
                      }*/
