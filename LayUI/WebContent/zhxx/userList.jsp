...
<input type="hidden" id="typeDj"
	value="<%=request.getParameter("typeDj")%>">
<!-- flag判断值 -->
...
<form class='layui-form' id="vform" onsubmit="return false" >
				<div id="demoTable" style='position:relative;'>
					...
					<div id='button' >
							&nbsp;&nbsp;&nbsp;<button type='button' id='reload_btn' class='layui-btn ' data-type='reload'>搜索</button>
...
<script src="statics/js/model/user_Index.js"></script>
</div>
</body>
</html>
