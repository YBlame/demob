			...
			while (rs.next()) {
				...
				for (int i = 1; i <= columnCount; i++) {
					if (rs.getObject(i) != null) {
						...
						}else if(md.getColumnName(i).equals("DWBH")){
							dwbh=rs.getObject(i).toString();							
						}else if(md.getColumnName(i).equals("ZGH")){
							zgh=rs.getObject(i).toString();							
						}else if(md.getColumnName(i).equals("ZWH")){
					...
					if (rs.getObject(i) == null) {
						...
						if(flag.equals("true")){
							...
							if(md.getColumnName(i).equals("FYXXZT")){
								String wtg="<div><div style='text-align: center;'><a  href='DJ/BGXX_EDIT_JJ.jsp?bgGuid="+guids+"' class='layui-table-link'><img src='statics/icon/ch.png' style='margin-top:4px;'></a></div><div>";
							...
							}else if(md.getColumnName(i).equals("FKTZDZT")){//+ guids + "','"  + zgh + "','"  + zwh + "','" + dwbh 								
								String wtj="<div><div style='text-align: center;'><img src='statics/icon/ffwtj.jpg' style='margin-top:4px;'></div><div>";
								String yfs="<div><div style='text-align: center;'><a  href='zhxx/fktzd.jsp?shguid="+guids+"&dwbh="+dwbh+"&zgh="+zgh+"&zwh="+zwh+"' class='layui-table-link' target='_blank'><img src='statics/icon/ffyfs.jpg' style='margin-top:4px;'></a></div><div>";
